...
- `dev0.axis0.controller.config.pos_gain = 20.0`
  - 设置合适的比例增益。
- `dev0.axis0.controller.config.vel_gain = 0.16`
  - 根据电机特性设定速度环增益。
- `dev0.axis0.controller.config.vel_integrator_gain = 0.32`
  - 设定速度积分增益, 确保稳定性。
...
dev0.axis1.controller.config.vel_gain = 0.16
dev0.axis1.controller.config.vel_integrator_gain = 0.32
